...
| 2 | **Port DNA PAM generation** | C generates DNA scores dynamically via `generatenuc1pam` + PAM^200 (Kimura R=2). We use a static table. 291/676 cells differ. | Medium |
...
- **Items 1-4**: Close the quality gap.
